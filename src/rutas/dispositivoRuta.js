...
var controladorDispositivo = require('../controladores/controladorDispositivo');
...
api.get('/getDevices', controladorDispositivo.listarDispositivo);
...
api.post('/addDevice', controladorDispositivo.agregarDispositivo);

//cargar las rutas put
api.put('/updateDevice', controladorDispositivo.actualizarDispositivo);

//cargar las rutas delete
api.delete('/removeDevice', controladorDispositivo.eliminarDispositivo);
